      ...
      <Fragment>
        <Routes>
          ...
          <Route
            ...
            element={<SnapshotView isAuth={isAuth} setAuth={setAuth} />}
          />
          <Route
            path="teacher/login"
            element={<TeacherLogin isAuth={isAuth} setAuth={setAuth} />}
          />
          <Route
            path="teacher/signup"
            element={<TeacherSignup isAuth={isAuth} setAuth={setAuth} />}
          />
          <Route
            path="teacher/menu"
            element={
